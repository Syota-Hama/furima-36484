class User < ApplicationRecord
  ...
  with_options presence: true do
    validates :nickname, format: {with: /\A[ぁ-んァ-ヶ一-龥々ー]+\z/, message: "Nickname can't be blank"}
    ...
    validates :first_name_hurigana, format: {with: /\A[ァ-ヶー]+\z/, message: "First name kana is invalid. Input full-width katakana characters"}
    validates :family_name_hurigana, format: {with: /\A[ァ-ヶー]+\z/, message: "Last name kana is invalid. Input full-width katakana characters"}
    validates :birthday
  end
end
